...
Refaktor is designed to work consistently across Linux, macOS, and Windows, while handling platform-specific quirks intelligently.
...
### Windows (NTFS)
Windows filesystems are typically case-insensitive. Refaktor provides:
