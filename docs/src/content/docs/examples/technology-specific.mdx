...
description: Renaming examples for specific programming languages and frameworks
---
...
```bash
# Always start with plan --dry-run for unfamiliar codebases
renamify plan pattern replacement --include "src/**" --dry-run
```
