...
This feature is essential for maintaining brand identity and preventing incorrect word splitting in compound names like "DocSpring", "GitHub", or "TweetGit".
...
atomic = ["DocSpring", "GitHub", "TweetGit", "FormAPI"]
```
