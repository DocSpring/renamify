...
description: A case study showing how we renamed a command-line argument across the codebase
---

This case study demonstrates using Renamify to rename a command-line argument across an entire codebase,
including documentation, tests, and code.

## Background

The initial code for the Renamify CLI had an inconsistency in its argument naming:
...
A few minor issues to tidy up, then everything was done and all the tests were passing.
