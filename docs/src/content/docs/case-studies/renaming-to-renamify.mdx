---
title: Renaming to Renamify
description: How I used this tool to rename the project to something else
---

The original name for this took was "Refaktor". I decided that "Renamify" would be a better
name, because it's more about renaming thing and less about refactoring.
...
Renamify excludes dotfiles by default, so I also had to run it on some
specific dotfiles and directories:
...
Finally, I needed to rename the `.rfignore` (For **r**e**f**actor) file to `.rnignore` (for **r**e**n**amify):
...
All that was left to do was rename the GitHub repository and the project directory.
Then I committed and pushed to the new repo.
