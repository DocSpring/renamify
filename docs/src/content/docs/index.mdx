...
<span style="font-size: 1.35rem;">
An **MCP Server**, **CLI tool**, and **VS Code / Cursor Extension**
</span>
...
Renamify is a tool that understands different naming conventions and can rename both file contents and the files themselves in a single atomic operation. It's designed for developers (and AI agents) who need to refactor codebases safely and efficiently.
