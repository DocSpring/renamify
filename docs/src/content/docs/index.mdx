...
Smart search & replace for code and files with <br/>**case-aware replacements**
...
<CardGrid>
	...
	<Card title="Rust Performance" icon="rocket">
		Fast, memory-safe, cross-platform with [>90% test coverage](https://codecov.io/gh/DocSpring/renamify).
	</Card>
</CardGrid>
...
Renamify is a tool that understands different naming conventions and can rename both file contents and the files themselves in a single atomic operation.
It's designed for developers (and AI agents) who need to rename terms safely and efficiently.
