...
```bash
refaktor plan <OLD> <NEW> --dry-run [OPTIONS]
```
...
refaktor dry-run getUserName fetchUserProfile

# Test specific paths
refaktor dry-run old_name new_name src/ tests/

# Test include patterns
refaktor dry-run old_name new_name --include "src/**/*.{js,ts}"
