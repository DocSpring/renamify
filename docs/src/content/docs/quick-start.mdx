...
1. **Preview is automatic** - Renamify shows a preview by default before
   applying
2. **Commit before large renames** - Makes git-based rollback possible in
   addition to Renamify's built-in history
