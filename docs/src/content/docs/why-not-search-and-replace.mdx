...
Example: rename `smart_search_and_replace` to `refaktor`.

It handles:

```
/smart_search_and_replace/                  -> /refaktor/
/docs/smart-search-and-replace-guide.md     -> /docs/refaktor-guide.md
smart_search_and_replace.exe                -> refaktor.exe
SmartSearchAndReplace.java                  -> Refaktor.java
```

And updates common import patterns:

```
import smart_search_and_replace.core    -> import refaktor.core
require('smart-search-and-replace')     -> require('refaktor')
use smart_search_and_replace::scanner;  -> use refaktor::scanner;
```
