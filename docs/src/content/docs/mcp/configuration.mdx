...
<Aside type="tip">
  The MCP server will automatically detect renamify in your PATH. You only need
  to set `RENAMIFY_PATH` if: - renamify is installed in a non-standard location
  - You want to use a specific version - You're testing a development build
</Aside>
