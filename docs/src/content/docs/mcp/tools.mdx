...
The Renamify MCP Server provides 10 specialized tools for AI agents to perform
intelligent renaming operations.

## renamify_search

Search for identifiers across your codebase to understand their usage before
renaming.
...
Creates a comprehensive renaming plan that identifies all case variations of
your identifiers.
