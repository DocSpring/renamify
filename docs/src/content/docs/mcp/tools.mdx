...
<CardGrid>
  <Card title="refaktor_plan" icon="document">
    Create a refactoring plan with case-aware transformations
  </Card>
  <Card title="refaktor_apply" icon="approve-check">
    Execute a plan to make the actual changes
  </Card>
  <Card title="refaktor_undo" icon="undo">
    Revert a previously applied refactoring
  </Card>
  <Card title="refaktor_redo" icon="redo">
    Re-apply an undone refactoring
  </Card>
  <Card title="refaktor_history" icon="history">
    View past refactoring operations
  </Card>
  <Card title="refaktor_status" icon="information">
    Check current state and pending plans
  </Card>
  <Card title="refaktor_preview" icon="eye">
...
```
Successfully applied plan rf_20240115_123456
  ✓ Modified 12 files
...
```
Successfully undone refactoring rf_20240115_123456
...
```
Successfully redone refactoring rf_20240115_123456
...
Pending Plans:
  rf_20240115_150234 - oldFunction → newFunction
    Created: 5 minutes ago
    Status: Not applied
    Files: 8, Replacements: 23

Last Applied:
  rf_20240115_143022 - getUserData → fetchUserData
    Applied: 1 hour ago
    Status: Success
