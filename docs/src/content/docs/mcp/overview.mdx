...
- **refaktor_plan** - Create a refactoring plan with case-aware transformations
- **refaktor_apply** - Execute a plan to make the actual changes
- **refaktor_undo** - Revert a previously applied refactoring
- **refaktor_redo** - Re-apply an undone refactoring
- **refaktor_history** - View past refactoring operations
- **refaktor_status** - Check current state and pending plans
- **refaktor_preview** - Review a plan in different formats
