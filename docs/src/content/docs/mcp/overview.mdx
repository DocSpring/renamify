...
The Renamify MCP Server enables AI assistants to perform intelligent, case-aware refactoring operations on your codebase.
...
The **Model Context Protocol (MCP)** is an open standard that enables AI assistants to securely connect to external tools and data sources. The Renamify MCP Server implements this protocol, allowing AI agents to:
...
- [**renamify_plan**](/renamify/mcp/tools#renamify_plan) - Create a refactoring plan with case-aware transformations
- [**renamify_apply**](/renamify/mcp/tools#renamify_apply) - Execute a plan to make the actual changes
- [**renamify_undo**](/renamify/mcp/tools#renamify_undo) - Revert a previously applied refactoring
- [**renamify_redo**](/renamify/mcp/tools#renamify_redo) - Re-apply an undone refactoring
- [**renamify_history**](/renamify/mcp/tools#renamify_history) - View past refactoring operations
